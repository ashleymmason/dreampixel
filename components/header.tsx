      ...
      <div className="container flex h-[4.5rem] items-center justify-between transition-[height] duration-300 md:h-20" data-scrolled={scrolled}>
        ...
        <nav className="hidden items-center gap-8 lg:flex" aria-label="Primary navigation">
          ...
          <div className="relative" onMouseEnter={() => setServicesOpen(true)} onMouseLeave={() => setServicesOpen(false)}>
            ...
            <div className={cn("absolute left-1/2 right-auto top-full mt-5 w-[56rem] max-w-[calc(100vw-2rem)] -translate-x-1/2 border border-border bg-card p-6 shadow-2xl transition-all duration-200 xl:left-auto xl:right-0 xl:translate-x-0", servicesOpen ? "visible translate-y-0 opacity-100" : "invisible -translate-y-2 opacity-0")}>
