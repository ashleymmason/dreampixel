...
export function Header() {
  ...
  <Link href="/glossary/" className="nav-link">Dictionary</Link>
      ...
      <div ref={menuPanelRef} id="mobile-navigation" aria-hidden={!open} className={cn("absolute inset-x-0 top-full z-[60] h-[calc(100dvh-4.5rem)] overflow-y-auto bg-[hsl(var(--background))] px-6 pb-8 pt-6 transition-[opacity,visibility] duration-300 md:hidden", open ? "visible opacity-100" : "invisible opacity-0")}>
