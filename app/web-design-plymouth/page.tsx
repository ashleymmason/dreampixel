...
export const metadata = {
  title: "Web Design in Plymouth | Professional Website Design Services",
  description:
    "Expert web design services in Plymouth. We create beautiful, functional websites that help your business stand out and convert visitors into customers.",
}
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/plymouth-hoe-aerial.jpeg')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Professional, creative web design services for businesses in Plymouth, Britain's Ocean City. Stand out
              from the competition with a website that converts visitors into customers.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>Plymouth-Focused Design</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-green-500" />
      ...
      {/* About Web Design in Plymouth */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">Web Design Services in Plymouth</h2>
              <p className="text-lg text-muted-foreground">
                At Dream Pixel, we provide comprehensive web design services to businesses in Plymouth, Devon's largest
                city and a major maritime hub. Our team of experienced designers and developers create websites that not
                only look stunning but also drive results for your business in this diverse and dynamic market.
              </p>
              <p className="text-lg text-muted-foreground">
                Whether you're a marine business at the waterfront, a retail shop in Drake Circus, a tech startup at the
                Science Park, or any other Plymouth enterprise, we tailor our web design services to meet your specific
                needs and goals. From responsive design to e-commerce functionality, we have the expertise to bring your
                vision to life.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Rank higher in Plymouth searches</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
            ...
            <div className="relative">
              ...
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/plymouth.jpg-Ihb50n6w3Kf3sItBpD2BfQII49ikWx.jpeg"
                alt="Plymouth coastline with a lighthouse and waterfront buildings"
                width={600}
                height={600}
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Dream Pixel for Web Design in Plymouth?</h2>
            <p className="text-xl text-muted-foreground">
              We understand Plymouth's diverse business landscape and create websites that make an impact
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2">Plymouth Market Knowledge</h3>
                <p className="text-muted-foreground">
                  We understand Plymouth's unique business landscape, from its maritime heritage to its growing tech and
                  creative sectors, helping you connect with local customers effectively.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2">Maritime & Tourism Focus</h3>
                <p className="text-muted-foreground">
                  With Plymouth's strong maritime and tourism sectors, we specialize in creating websites that appeal to
                  both locals and visitors to Britain's Ocean City.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  your business objectives in Plymouth's competitive market.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  accessible to businesses of all sizes in Plymouth, from startups to established enterprises.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  ensure your Plymouth business continues to thrive online.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  Plymouth business establish a strong online presence in this competitive city.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Web Design Process for Plymouth Businesses</h2>
            ...
            <div className="space-y-12 relative">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right space-y-4 order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">
                    We start by understanding your Plymouth business, your goals, target audience, and local competitors
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    consistency, and elements that will appeal to your Plymouth customer base.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right space-y-4 order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    code and SEO best practices tailored to help you rank for Plymouth-related searches.
                  </p>
                </div>
                <div className="relative order-1 md:order-2">
                  <div className="absolute -inset-4 bg-purple-100 rounded-full blur-3xl opacity-30 hidden md:block"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    everything works perfectly for your Plymouth customers and visitors.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-purple-50 to-green-50">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">Ready to elevate your Plymouth business online?</h2>
              <p className="text-xl text-muted-foreground">
                Contact us today for a free consultation and quote. Let's create a website that helps your Plymouth
                business stand out in Britain's Ocean City and attract more customers from the local area and beyond.
              </p>
