...
export const metadata = {
  title: "Web Design in Bideford | Professional Website Design Services",
  description:
    "Expert web design services in Bideford. We create beautiful, functional websites that help your business stand out and convert visitors into customers.",
}

export default function WebDesignBideford() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/bideford-waterfront.png')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Professional, creative web design services for businesses in Bideford and the surrounding areas. Stand out
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>Serving Bideford Businesses</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-green-500" />
      ...
      {/* About Web Design in Bideford */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">Web Design Services in Bideford</h2>
              <p className="text-lg text-muted-foreground">
                At Dream Pixel, we provide comprehensive web design services to businesses in Bideford, a historic port
                town with a rich maritime heritage. Our team of experienced designers and developers create websites
                that not only look stunning but also drive results for your business.
              </p>
              <p className="text-lg text-muted-foreground">
                Whether you're a small local business on the quayside, a tourism-related enterprise, or a larger company
                in the Bideford area, we tailor our web design services to meet your specific needs and goals. From
            ...
            <div className="relative">
              ...
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bideford-GV1WBq3qvLpuYddC63LmBMmDELeZwd.png"
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Dream Pixel for Web Design in Bideford?</h2>
            <p className="text-xl text-muted-foreground">
              We understand Bideford's unique character and business landscape
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  We understand Bideford's unique character, from its historic quayside to its vibrant business
                  community, helping you connect with local customers effectively.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2">Tourism Focus</h3>
                <p className="text-muted-foreground">
                  With Bideford's strong tourism sector, we specialize in creating websites that appeal to visitors and
                  showcase the best of what your business offers to tourists.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  your business objectives in the competitive Bideford market.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  accessible to businesses of all sizes in Bideford and the surrounding areas.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-purple-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  ensure your Bideford business continues to thrive online.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 border-green-100">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  Bideford business establish a strong online presence.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Web Design Process for Bideford Businesses</h2>
            ...
            <div className="space-y-12 relative">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right space-y-4 order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">
                    We start by understanding your Bideford business, your goals, target audience, and local competitors
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    consistency, and elements that will appeal to your Bideford customer base.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right space-y-4 order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    code and SEO best practices tailored to help you rank for Bideford-related searches.
                  </p>
                </div>
                <div className="relative order-1 md:order-2">
                  <div className="absolute -inset-4 bg-purple-100 rounded-full blur-3xl opacity-30 hidden md:block"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    everything works perfectly for your Bideford customers and visitors.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-purple-50 to-green-50">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold">Ready to elevate your Bideford business online?</h2>
              <p className="text-xl text-muted-foreground">
                Contact us today for a free consultation and quote. Let's create a website that helps your Bideford
                business stand out from the competition and attract more customers from the local area and beyond.
              </p>
