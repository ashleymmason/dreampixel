      ...
      <section className="relative isolate bg-background text-foreground">
        <div className="container flex min-h-[calc(100svh-5rem)] flex-col justify-between pb-10 pt-12 md:pt-20">
          <div className="relative py-12 md:py-20">
            ...
            <p className="mt-8 max-w-sm text-sm leading-6 text-foreground/65">Dream Pixel designs and builds high-performance websites that help ambitious businesses explain their value, earn trust and get found.</p>
